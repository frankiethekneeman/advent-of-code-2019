...
main = do
  ...
  let inst = map fromEnum $ unlines instructions
  let computer = boot{memory=program, io = ListIO inst []}
  putStrLn $ last $ lines $ map toEnum $ reverse $ o $ io $ executeProgram computer
